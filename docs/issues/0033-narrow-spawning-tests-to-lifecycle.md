# Issue 0033: Narrow BTW Process spawning tests to lifecycle behavior
...
- Issue 0031 — needs the parser module
- Issue 0032 — needs parser tests to own the edge cases first
